 ...
 * @author abarrios
 */
public class ValidarFormatoCorreoElectronico {

    public ValidarFormatoCorreoElectronico() {

    }

    public static boolean validarFormatoCorreoElectronico(String correoElectronico) {
